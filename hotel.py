    ...
    if st.button("Confirm Booking", disabled=not terms):
        with st.spinner("Processing your booking..."):
            try:
                ...
                encoder, model, features = load_models()
                categorical_cols = ['Preferred Cusine', 'most_frequent_dish',
                ...
                for i, dish in enumerate(top_3_dishes[0], 1):
                    discount = "20% off!" if "thali" in dish.lower() else "15% off!"
